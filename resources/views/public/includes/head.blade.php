...
<link type="text/css" rel="stylesheet" href="{{ url('/user/css/slick-theme.css') }}" />
<!-- nouislider -->
<link type="text/css" rel="stylesheet" href="{{ url('/user/css/nouislider.min.css') }}" />
<!-- Font Awesome Icon -->
...
<script src="{{ url('user/js/register.js') }}"></script>
